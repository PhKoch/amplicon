...
def main():
	...
	outtabfilename = Path(args.fastq.name).stem + ".matches.tsv"
	...
	# output a summary
	print ("# Summary: (last line for easy parsing)")
	...
	print ("%s\t%i\t%i\t%i" % (args.fastq.name,readnumber,matchnumber,len(unmatchedreads)))
